<%@ Page Title="Benefits Learn Tab" 
    Language="vb" 
    AutoEventWireup="false" 
    MasterPageFile="~/AppMasterHeader.Master" 
    CodeBehind="EE_Learn.aspx.vb" 
    Inherits="HReaseApp.EE_Learn" 
...
<asp:Content ID="MainBlock" ContentPlaceHolderID="MainArticle" Runat="Server" >
     <div class="HREwrapper">
        <div id="divPageTitle" >
            <div>
                <br />
                <h4><b>Benefit Education Information</b></h4>
            </div>
        </div>
        ...
        <div id="divMainArticalTitleandText" runat="server" class="well HRESlateBlue HRERewrap">
         ...
         <div class="col1">
             <div class="item itemOdd" id="LeftDocument1" runat="server" style="float:left; width:70%;">
