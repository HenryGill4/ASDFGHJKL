<%@ Page Title="NY Salary Notice to Hourly Employees" 
    Language="vb" 
    AutoEventWireup="false" 
    MasterPageFile="~/AppMasterHeader.Master" 
    CodeBehind="EE_Compliance_NY1.aspx.vb" 
    Inherits="HReaseApp.EE_Compliance_NY1"
...
<asp:Content ID="MainArticle" ContentPlaceHolderID="MainArticle" runat="server">
    ...
    <div class="HREwrapper">
        <div id="divPageTitle">
            <div>
                <br />
                <h4><b>New York Notice for Hourly Rate Employees</b></h4>
            </div>
        </div>
        ...
        <div id="NYComplianceForm1" runat="server">
            <div class="well HREWhite HRERewrap" style="color:black; font-size:medium;">
                <div id="formheader" class="row" style="margin-bottom: 20px;">
                    ...
                    <div id="divFormtitle" runat="server" style="width:90%; float:none; padding-left:10%; text-align:center;">
                        <b>Notice and Acknowledgement of Pay Rate and Payday
                            <br />Under Section 195.1 of the New York State Labor Law
                            <br />Notice for Hourly Rate Employees</b>     
                    </div> 
                </div>
                ...
                <div id="mainform" class="row" style=" width:100%;">
                    ...
                    <div id="column2" style="float:left; width:30%; padding-left:3%;">
                        <div style="padding:10px;">
                                <b>3. Employee’s rate of pay: </b>
                            <div style="padding:20px; ">
                                $<b class="text-underline" style="width:50px; padding-left:2px;">
                                    <asp:Label ID="lblEmployeePayRate" runat="server"/> </b>
                                &nbsp;per hour
                            </div>
                           ...
                           <div class="form-group" style="text-align:left; padding-left:3%;">
                            ...
                            <div class="form-group" style="text-align:left; padding-left:3%;">
                                $<b><asp:Textbox ID="txtOvertime" runat="server" width="30%" onkeypress="return onlyNumbers()" onfocusout="return isDecimal(evt)" onblur="makeMoney(this)" /></b>
