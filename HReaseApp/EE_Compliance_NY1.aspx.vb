...
Public Class EE_Compliance_NY1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strScreenName = "EEComplianceNY1"
        strScreenShortDesc = "NY Notice for Hourly Employees"
    ...
    Private Sub PopulateFields()
        ...
        If ec.GetEmployeeInfo(intCompanyId, intEmployeeId) = True Then
            lblEmployeePayRate.Text = ec.SalaryAmount
    ...
    Private Sub Save()
        ...
        If txtOvertime.Text = "" Then
            divError.Visible = True
            divSuccess.Visible = False
            lblError.Text = "You must enter an amount on Line 7. Overtime Pay Rate"
            txtOvertime.BackColor = System.Drawing.ColorTranslator.FromHtml("#f2dede")
            imgNext.Visible = False
            ResetScrollPosition()
            Exit Sub
        End If
        ...
        If Session("Admin") = "False" Then
            If chkEnglish.Checked = False And chkNotEnglish.Checked = False And Session("Admin") = "False" Then
                divError.Visible = True
                divSuccess.Visible = False
        ...
        txtOvertime.BackColor = System.Drawing.ColorTranslator.FromHtml("#f0f4fa")
